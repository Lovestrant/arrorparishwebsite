...
if($row['phonenumber']== $_SESSION['phonenumber']){
    ...
    <div style='height: auto; width:80%; margin: 20px; padding: 10px;background-color: lightblue; margin-left:20%;
    ...
    <div style='height: auto; width:80%; margin: 20px; padding: 10px;background-color: lightgreen; 
     border-radius: 10px; border-radius: 10px; '>
     <p style='color: blue; margin:0;'>".$row['firstname']."-".$row['lastname']."</p>
     <p style='color: orange;'>".$row['phonenumber']."<br></p>
     ".$row['chattext']."</div>
